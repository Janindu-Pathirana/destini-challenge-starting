...
class StoryBrain {
  ...
  int get storyNum => _storyNum;

  set storyNum(int value) {
    _storyNum = value;
  }

  bool get visible => _visible;

  String getStory(int num) => _storyData[num].storyTitle;
  String getChoice1(int num) => _storyData[num].choice1;
  String getChoice2(int num) => _storyData[num].choice2;
